...
mod admin_auth_tests {
    ...
    const ADMIN_API_ROUTES: &[(&str, &str)] = &[
        ...
        ("GET", "/admin/usage/filter-options?field=provider"),
        ("GET", "/admin/usage/export"),
        ("GET", "/admin/usage/aggregate"),
        ("GET", "/admin/upstream-quotas"),
        ("POST", "/admin/upstream-quotas/refresh"),
        ("GET", "/admin/upstream-quotas/account-id"),
        ("POST", "/admin/upstream-quotas/account-id/refresh"),
        ...
        ("GET", "/admin/audit"),
        ("GET", "/admin/events"),
        ("GET", "/admin/events/filter-options?field=event_type"),
