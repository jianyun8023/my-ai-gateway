      ...
      <section className={styles.workspace}>
        <header className={styles.topbar} data-od-id="topbar">
          ...
          <div className={styles.headerActions}>
            <label className={styles.keyInput}><span>Admin Key</span><input aria-label="Admin Key" autoComplete="off" spellCheck={false} type="password" value={adminKeyDraft} onChange={(event) => setAdminKeyDraft(event.target.value)} placeholder={adminKeyConfigured ? '当前会话已配置' : '可留空'} /><Button size="sm" variant="secondary" onClick={applyAdminKey}>应用</Button></label>
